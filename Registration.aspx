    ...
    <div class="registration1">
        ...
        <div>
            <ul class="right">
                ...
                <li><asp:TextBox ID="txtName" runat="server" CssClass="right"></asp:TextBox>
      ...
      <asp:Label ID="Label3" runat="server" Text="Email Address"></asp:Label>
        <li><asp:TextBox ID="txtEmail" runat="server"></asp:TextBox>
        ...
        <li><asp:TextBox ID="txtPhone" runat="server"></asp:TextBox><br />  
       ...
       <asp:Label ID="lblAddress" runat="server" Text="Address"></asp:Label>
        <li><asp:TextBox ID="txtAddress" runat="server"></asp:TextBox>
        ...
        <li><asp:TextBox ID="txtCity" runat="server"></asp:TextBox>
      ...
      <asp:Label ID="lblState" runat="server" Text="State"></asp:Label>
        <li><asp:DropDownList ID="ddlState" runat="server" Font-Names="Segoe UI" Height="40px">
...
<asp:Label ID="lblCountry" runat="server" Text="Country"></asp:Label>
        <li><asp:DropDownList ID="ddlCountry" runat="server" Font-Names="Segoe UI" Height="40px">
       ...
       <asp:Label ID="lblPassword" runat="server" Text="Password"></asp:Label>
        <li><asp:TextBox ID="txtPassword" runat="server" TextMode="Password"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidatorPassword" runat="server"
        ...
        <li><asp:TextBox ID="txtReenterPassword" runat="server" TextMode="Password">
        ...
        <br />
        <li><asp:Button ID="Button1" runat="server" Text="Register" /></li></ul>    
    </div>
        </div>
