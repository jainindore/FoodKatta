<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="topRecipes.aspx.cs" Inherits="topRecipes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <script src="topRecipes.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="search-moment dark" >
        <div class="findRecipe" style="width:52.375rem"><h2>Search a Category</h2>
